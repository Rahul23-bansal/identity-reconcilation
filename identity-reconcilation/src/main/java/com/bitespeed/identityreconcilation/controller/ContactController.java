...
public class ContactController {
    ...
    @PostMapping
    public ResponseEntity<WrappedContactResponseDto> identifyContact(@RequestBody ContactRequestDto contactRequest){
        ...
        WrappedContactResponseDto contactResponse = contactService.buildContactResponse(contact);
